...
export class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    const bottom = new Phaser.Math.Vector2(0, h * 0.8); 
    const top = new Phaser.Math.Vector2(w, h * 0.46); 
    const control1 = new Phaser.Math.Vector2(w * 0.2, h * 0.81);
    const control2 = new Phaser.Math.Vector2(w * 0.5, h * 0.85); 
    const control3 = new Phaser.Math.Vector2(w * 0.8, h * 0.67); 
